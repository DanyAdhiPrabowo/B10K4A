  ...
  <body>
    <div class="container">
        ...
        <div class="mb-5 pb-5" style="height: 100px">
            <table>
                <form method="post" action="Programmer/tambahProgrammer">
                    <tr>
    	    ...
    	    <table class="table table-bordered">
    	    	<tr>
    	    		...
    	    		<td rowspan="2" width="300px">
                        <form method="post" action="<?=base_url('Programmer/tambah/'.$id) ?>">
    	    	...
    	    	<tr>
                    <td>
                    <?php 
                    $skill = $this->model->get_by('skills', 'user_id', $id)->result();
                    foreach ($skill as $s) { 
                        echo $s->name.', ';
                    } ?>
                </td>
